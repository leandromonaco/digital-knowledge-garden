...
IDENTITY_VALUE = 'IDENTITY_VALUE_STRING' ENCRYPTION BY PASSWORD = 'SOME_PASSWORD'
...
DECRYPTION BY PASSWORD = 'SOME_PASSWORD'
```
...
```sql
DECLARE @encryptedData VARBINARY(200) = "<Substitute the binary data with result from step 3>"
DECLARE @auth VARCHAR(40) = '7AECFD07-4643-41FC-B17C-472AD71699E7'
